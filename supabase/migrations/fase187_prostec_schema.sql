...
drop policy if exists "prostec_companies_staff" on prostec_companies;
...
drop policy if exists "prostec_searches_staff" on prostec_prospecting_searches;
...
drop policy if exists "prostec_leads_staff" on prostec_leads;
create policy "prostec_leads_staff" on prostec_leads for all using (current_user_cargo() in ('admin', 'gerente', 'vendedor_prostec'));
drop policy if exists "prostec_lead_sources_staff" on prostec_lead_sources;
...
drop policy if exists "prostec_lead_scores_staff" on prostec_lead_scores;
...
drop policy if exists "prostec_lead_contacts_staff" on prostec_lead_contacts;
...
drop policy if exists "prostec_lead_notes_staff" on prostec_lead_notes;
...
drop policy if exists "prostec_lead_followups_staff" on prostec_lead_followups;
...
drop policy if exists "prostec_lead_status_history_staff" on prostec_lead_status_history;
...
drop policy if exists "prostec_sales_staff" on prostec_sales;
create policy "prostec_sales_staff" on prostec_sales for all using (current_user_cargo() in ('admin', 'gerente', 'vendedor_prostec'));
drop policy if exists "prostec_commissions_staff" on prostec_commissions;
...
drop policy if exists "prostec_settings_staff" on prostec_settings;
