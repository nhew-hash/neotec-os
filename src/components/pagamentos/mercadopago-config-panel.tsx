      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <p className="rounded-lg bg-secondary/60 p-2.5 text-[11px] text-muted-foreground">
            O acréscimo do cartão no checkout usa a tabela de taxas de parcelamento já configurada em Financeiro → Parcelamento (taxa da parcela 1x) — não precisa configurar de novo aqui.
          </p>
